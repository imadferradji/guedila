...
import '../../Widgets/commande_widget_C.dart';

class CommandePageC extends StatefulWidget {
  final String username="Oussama Bensbaa";
  final double solde=100000.00;


  CommandePageC({Key? key}) : super(key: key);
  @override
  State<CommandePageC> createState() => _CommandePageC();
}

class _CommandePageC extends State<CommandePageC> {
                        ...
                        Expanded(
                          ...
                          Container(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L", pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "Livrée", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: false, montant: "150000.00", date: "Sep 13, 2020", etat: "En attente", NomC: "elchapo", Ncommande: 125367, ),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "En attente", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: false, montant: "150000.00", date: "Sep 13, 2020", etat: "Permis", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "Permis", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "Livrée", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: false, montant: "150000.00", date: "Sep 13, 2020", etat: "Validé", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "Livrée", NomC: "elchapo", Ncommande: 125367,),
                                  SizedBox(height: 15,),
                                  CommandeWidgetC (quantite: "12 plt", produit: "0.5 L",  pallete: true, montant: "150000.00", date: "Sep 13, 2020", etat: "Livrée", NomC: "elchapo", Ncommande: 125367,),
