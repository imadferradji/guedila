                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => Decision(
                                  prixPalette: 500,
                                  totalCommande: total.toInt(),
                                  nbPalette: quantite,
                                  nomproduit: widget.nomproduit,
                                ),
                              ),
                            ).then((result) {
                              // When we come back from Decision, pass the result back to the previous screen
